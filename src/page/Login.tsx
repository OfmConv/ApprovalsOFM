  ...
  return (
    <div className="min-h-screen flex bg-[#bcd1e1]">
        ...
        <form onSubmit={handleLogin}>
          {changeForm === 'welcome' ?
            (
              ...
              (
                <Card onSubmit={handleLogin} className="w-80 rounded-2xl relative overflow-hidden"
                  style={{
                    background: "#ffffff",
                    border: "0.5px solid rgba(46,97,147,0.15)",
                    boxShadow: "0 24px 60px rgba(0,0,0,0.3)",
                ...
                >
                  ...
                  <CardContent className="px-8 pb-5 pt-3.5 space-y-3 relative z-10">
                    ...
                    <Field className="pb-5">
                      <FieldLabel htmlFor="input-field-password" style={{ color: '#122C45' }}>
                        Password
                      </FieldLabel>
                ...
                <Card
                  ...
                  <CardContent className="px-8 pb-5 pt-3.5 space-y-3 relative z-10">
                    ...
                    <Field className="pb-5">
                      ...
                      <div className="relative">
                        <Input
                          onChange={(e) => setPassword(e.target.value)}  // ✅ was missing
                          value={password}
                          id="input-field-password"
                          type={showPassword ? "text" : "password"}
                          placeholder="Enter your password"
      ...
      {/* <div className="hidden lg:block lg:w-[30%] relative">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#bcd1e1_0%,transparent_30%)] pointer-events-none" />
      </div> */}
      ...
      {/* <Modal
        title="Server Error"
        description="Oops! Something went wrong on our end. Please try again later or contact support if the issue persists."
        open={showErrorModal}
