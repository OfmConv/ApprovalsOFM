...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    size: 22,
    cell: ({ row }) => (
      <div className="w-full min-w-0 text-sm truncate">{row.original.email}</div>
    ),
  },
  {
    ...
    size: 16,
    cell: ({ row }) => (
      <div className="w-full min-w-0 text-sm truncate">{row.original.ktp_name || "-"}</div>
    ),
  },
  {
    ...
    size: 12,
    cell: ({ row }) => (
      <div className="w-full min-w-0 text-sm truncate">{row.original.place_of_birth || "-"}</div>
    ),
  },
  {
    ...
    size: 10,
    cell: ({ row }) => (
      <div className="w-full min-w-0 text-sm truncate">{formatDate(row.original.date_of_birth)}</div>
    ),
  },
]
...
export function DataTable({ data: initialData }: {
  ...
  return (
    <Tabs defaultValue="outline" className="w-full min-w-0 flex-col justify-start gap-6 ">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between px-4 lg:px-6">
