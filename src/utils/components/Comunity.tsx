...
// import { getAssignment, requestAssignmentChange } from "@/services/api";
...
// export default function CommunitySection({ nkp }: { nkp: string }) {
...
//                             </div>
//                             <div>
//                                 <h2 className="text-sm font-semibold text-gray-800">Komunitas & Karya (Tugas)</h2>
//                                 <p className="text-xs text-gray-400">Isi riwayat penugasan / komunitas.</p>
//                             </div>
//                         </div>
...
//                                             <p className="text-xs text-gray-400">{record.date?.split("T")[0]}</p>
//                                         </div>
//                                     </div>
